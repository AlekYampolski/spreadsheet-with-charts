...
var Actions = GcSpread.Sheets.SpreadActions;
...
var specialTabNames = ["table", "chart"];
...
function processRibbonClick(e, data) {
    var name = data.name, value = data.value, title = data.header || data.text || name, list = data.children;
    var sheet = spread.getActiveSheet();
    ...
    switch (name) {
        ...
        case "typeChart":
            ...
            ["columnChart", "lineChart", "pieChart", "barChart", "areaChart", "xy(scatter)Chart", "columnChartTypeChanged", "lineChartTypeChanged",
                "pieChartTypeChanged", "barChartTypeChanged", "areaChartTypeChanged", "xyscatterChartTypeChanged"].forEach(function(chartType) {
                if(chartType !== title) {
...
function attachFindEvents() {
    ...
    var $container = $("#findOptions"),
        ...
        var $lookin = $("input[name='radio-look']");
        var $resultContainer = $(".resultlist tbody", $container),
